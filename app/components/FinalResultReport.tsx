...
const DEBRIEFING_QUESTIONS = [
  {
    competency: '비전/방향',
    question: '(비전/방향) 팀장으로서 가장 중요한 첫 마디는 무엇이었나요? 부임 인사와 목표 설정 과정에서 팀원들의 반응은 어떠했나요? 현업에서 새로운 리더가 팀에 비전을 제시할 때 가장 중요한 것은 무엇일까요?',
  },
  {
    competency: '소통/신뢰',
        ...
        <div ref={reportRef} style={{ background: '#ffffff', color: '#333', borderRadius: '16px', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '40px', borderTop: '3px solid #eee', background: '#fafafa' }}>
            ...
            <p style={{ fontSize: '17px', lineHeight: '2', color: '#444' }}>
              ...
              {' '}각 팀은 부임 인사 작성, 팀 진단, 1:1 면담, 업무 배분, 팀빌딩, 핵심 인재 리텐션, 성과 면담, 숨은 역량 발견, 위기 대응, 조직 재편, AI 코칭 대화, 연말 성과보고 등
