...
export const R2_STORY = `취임 인사를 무사히 마쳤지만, 진짜 문제는 지금부터다.
전임 팀장이 갑자기 퇴사하면서 남긴 건 비밀번호로 잠긴 팀 진단 보고서뿐.
인수인계서에는 "진짜 문제는 이 안에 있다"는 의미심장한 메모만 휘갈겨져 있다.
책상 위 포스트잇, 캘린더 메모, 찢겨진 노트 조각...
흩어진 단서들을 모아 비밀번호를 해독하고, 팀의 진짜 문제를 파악하라!`;
export const R2_IMAGE = 'https://i.ibb.co/ZzysrM69/R2.jpg';
export const R2_CORRECT_ANSWER = '4035';
